...
public class Streams_08_SecondSmallestElementSortAscOfNNumbers {
    ...
    public void imperativeApproachUsingLists() throws IOException {
        ...
        System.out.println("\nSecond Smallest Element ::" + lstNumbers.get(1));
    }
    ...
    public void declarativeApproachUsingStreamsOnLists() throws Exception {
        ...
        System.out.println("Second Smallest Element ::" + sortedDescending.get(1));
    }
    ...
    public void declarativeApproachUsingIntStreamsUsingMapToObj() throws Exception {
        ...
        sortedNums.stream()
            .forEach(System.out::println);
        System.out.println("Second Smallest Element ::" + sortedNums.get(1));
    }
}
