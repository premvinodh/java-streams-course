...
public class Streams_07_SecondLargestElementSortDescOfNNumbers {
    ...
    public void imperativeApproachUsingLists() throws IOException {
        ...
        System.out.println("Second Largest Element ::" + lstNumbers.get(1));
    }
    ...
    public void declarativeApproachUsingStreamsOnLists() throws Exception {
        ...
        System.out.println("Second Largest Element ::" + sortedDescending.get(1));
    }
    ...
    public void declarativeApproachUsingIntStreamsUsingMapToObj() throws Exception {
        ...
        sortedNums.stream()
            .forEach(System.out::println);
        System.out.println("Second Largest Element ::" + sortedNums.get(1));
    }
}
